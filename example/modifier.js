...
setTypeString(types.int64, 'string');
setTypeString(types.uint64, 'string');
setTypeString(types.string, 'string');
setTypeString(types.bool, 'boolean');
setTypeString(types.void, 'any');
setTypeString(types.time_point_sec, 'string');
...
types.protocol_id_type = proxy(types.protocol_id_type, 'string');
