...
class GXClient {
    ...
    generateKey(brainKey) {
        brainKey = brainKey || bip39.generateMnemonic(160); // generate a new brain key if not assigned
     ...
     * @param fee_symbol {String} - The asset to pay the fee
     * @param broadcast {Boolean}
     * @returns {Promise<any>}
     */
    vote(accounts = [], fee_symbol = "GXC", broadcast = false) {
