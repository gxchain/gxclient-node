import {Aes, key, object_id_type, PrivateKey, PublicKey, string_to_name, TransactionHelper} from "gxbjs";
...
class GXClient {
     ...
     * @param amount_asset {String} - same to transfer
    ...
    /**
     * vote for accounts
     * @param account_ids {String[]} - An array of account_id to vote
     * @param fee_paying_asset {String} - The asset to pay the fee
     * @param broadcast {Boolean}
     * @returns {Promise<any>}
     */
